...
<body>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div style="margin-right: auto; font-size: 20px">
        ...
        <?php
                    if ($_SESSION != true){
                        ...
                        echo "<a class='nav-link disabled' href='#' tabindex='-1' aria-disabled='true'>Welcome $user_data[name]</a>";
        ...
        <!-- <div class="navbar2" >
          <button type="button" class="btn navbar-btn" onClick="location.href='index.php?logout=true'">
            <span class="glyphicon glyphicon-plus"></span> 
            Login
          </button>
        </div> -->
        ...
        <div class="navbar2" >
          <button type="button" class="btn navbar-btn" onClick="location.href='logout.php'">
            <span class="glyphicon glyphicon-plus"></span> 
            Logout
          </button> -->
        </div> 
